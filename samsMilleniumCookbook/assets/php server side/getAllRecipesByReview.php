...
/**
 * Following code will list all the recipes ordered by review count
 */
...
if (isset($_POST["foodName"])) {
	...
	$result = mysqli_query($conn, $query.$recipeTypeQuery.$cookTimeQuery.$authorQuery.$keyWordQuery.$foodNameQuery." ORDER BY reviewCount DESC, r.recipeName ASC");
