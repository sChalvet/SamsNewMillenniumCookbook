...
/*
 * Following code will list all the recipes ordered alpahabeticaly
 */
...
if (isset($_POST["foodName"])) {
	...
	$result = mysqli_query($conn, $query.$recipeTypeQuery.$cookTimeQuery.$authorQuery.$keyWordQuery.$foodNameQuery." ORDER BY r.recipeName ASC");
