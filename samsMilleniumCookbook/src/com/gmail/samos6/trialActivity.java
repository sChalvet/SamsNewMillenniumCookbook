...
public class trialActivity extends ListActivity {
	...
	class LoadAllProducts extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(trialActivity.this);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					adapter = new SamsListAdapter(trialActivity.this, productsList, list, "IngredientList");
