...
public class GetIngredientActivity extends ListActivity {
	...
	//variable that will hold the URL that is retrieved from resources below
	...
	private static final String TAG_GETINGREDIENT = "getIngredient";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnDone = (Button) findViewById(R.id.btnGetIngredientsDone);
		btnAdd = (Button) findViewById(R.id.btnGetIngredientsDone);
		...
		// save selected ingredients click event
				btnDone.setOnClickListener(new View.OnClickListener() {
							...
							public void onClick(View view) {
								...
								//returns the list of selected ingredients to CreateRecipeActivity
								Intent intent = new Intent();
								//intent.putExtra("allIngredients",list);
				...
				btnAdd.setOnClickListener(new View.OnClickListener() {
							...
							public void onClick(View view) {
								...
								intent.putExtra(TAG_ORIGIN, TAG_GETINGREDIENT);	
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// sending ingredientName to next activity
				intent.putExtra(TAG_INGREDIENTNAME, ingredientname);
				intent.putExtra(TAG_ORIGIN, "stuff");
